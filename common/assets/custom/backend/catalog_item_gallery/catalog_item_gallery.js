...
$(document).ready(function() {
    ...
    $("#sortable").sortable({
        ...
        update: function (event, ui) {
            ...
            $.ajax({
                type: "POST",
                url: "/modificator/gallery-sort.html",
                data: {
                    sort_data: data,
                    _csrf: csrfToken
                },
    ...
    var dell_item = function () {
        ...
        swal({
            ...
            function () {
                ...
                $.ajax({
                    type: "post",
                    url: "/modificator/dell-gallery-item.html",
                    data: {
                        'item_id': item_id,
                        _csrf: csrfToken
                    },
    ...
    var edit_item = function () {
        ...
        $('#modificatoritemimageform-image_id').val(item_id);
        ...
        $('#cropper-example-2-modal').modal('show').on('shown.bs.modal', function () {
            ...
            $('#modificatoritemimageform-image_id').val(null);
        });
    ...
    function showCoords(c) {
        $('#modificatoritemimageform-x').val(c.x);
        $('#modificatoritemimageform-y').val(c.y);
        $('#modificatoritemimageform-h').val(c.height);
        $('#modificatoritemimageform-w').val(c.width);
    }
    ...
    $('#picture-done-button').on('click',function(){
        ...
        $("#upload-picture-form").ajaxSubmit({
            url: '/modificator/gallery-add-picture.html',
            type: 'post',
