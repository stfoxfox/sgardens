...
<a class="fix-link" href="#"><span>собери пиццу сам</span><div class="ic icon-svg-2s"></div></a>
    ...
    <div data-row-fixed class="fixed">
        <div class="btn-group">
            ...
            <?php } else { ?>
            <a href="<?= Url::toRoute(['/cabinet/index']) ?>" class="btn border"><?= Yii::$app->user->identity->username ?></a>
        ...
        <div class="header row">
            ...
            <div class="right-col">
                <div class="main-nav row">
                    <div class="right-col">
                        <div class="phone">+7 495 <span>933-28-49</span></div>
            ...
            <ul class="menu nav" data-cat-menu>
                ...
                <?php } ?>                
                <li><a class="<?= (Yii::$app->controller->id == 'stock' && Yii::$app->controller->action->id == 'index')?'active':'';?>" href="<?= Url::toRoute(['/stock/index']) ?>">АКЦИИ</a></li>
            ...
            <button class="btn border cat-menu" onclick="MainManager.showMenu('data-cat-menu');">Выбрать категорию букета</button>
            <button class="btn border main-menu" onclick="MainManager.showMenu('data-main-menu');"><span></span></button>
